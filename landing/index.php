...
<html lang="en">
    <head>
        ...
        <title>SSR : ระบบบันทึกคะแนนการเรียนการสอนหลักสูตรวิชาชีพระยะสั้น</title>
        <!-- Bootstrap CSS -->
            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="./"><img src="img/logo.png" alt="" width="100"></a>
					...
					<div class="row">
						<div class="col-lg-5">
							<div class="banner_content">
								<h2>ระบบบันทึกคะแนน <br />หลักสูตรวิชาชีพระยะสั้น</h2>
								<p>ระบบบันทึกคะแนนการเรียนการสอนหลักสูตรวิชาชีพระยะสั้น
								</p>
						...
						<div class="col-lg-7">
							<div class="home_left_img">
								<img class="img-fluid" src="img/vec_banner.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
        		...
        		<div class="row footer_inner">
        			<div class="col-lg-5 col-sm-6">
        				<aside class="f_widget ab_widget">
        					...
        					<p><a href="http://www.rvc.ac.th" target="_blank">วิทยาลัยอาชีวศึกษาร้อยเอ็ด</a><br>
        				</aside>
        			</div>
        			<div class="col-lg-5 col-sm-6">
